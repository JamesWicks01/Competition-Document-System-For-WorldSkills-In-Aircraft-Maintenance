...
function AircraftTechnicalLogPage() {
    ...
    useEffect(() => {
        async function LoadData() {
          ...
          try {
            ...
            if (response && typeof response === "object") {
              ...
              document.getElementById("u429_input").value = dayjs(form.leg1_date).format('YYYY-MM-DD');
              ...
              document.getElementById("u435_input").value = dayjs(form.leg2_date).format('YYYY-MM-DD');
              ...
              document.getElementById("u446_input").value = dayjs(form.reported_date).format('YYYY-MM-DD');
              ...
              document.getElementById("u451_input").value = dayjs(form.resolved_date).format('YYYY-MM-DD');
              ...
              document.getElementById("u460_input").value = dayjs(form.independent_checkdate).format('YYYY-MM-DD');
              document.getElementById("u461_input").value = form.release_by || "";
              document.getElementById("u462_input").value = dayjs(form.release_date).format('YYYY-MM-DD');
        ...
        authUtils.readOnlyInputs();
        const cssFile = '/css/AircraftTechnicalLog.css';
        loadStyle(cssFile);
